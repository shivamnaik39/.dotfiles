...
globalkeys = my_table.join( -- {{{ Personal keybindings
    ...
    -- super + ... function keys
                 awful.key({modkey}, "F1",
                           ...
                           {description = browser1, group = "function keys"}),
                 awful.key({modkey}, "F2",
                           function() awful.util.spawn(editorgui) end,
        ...
        awful.util.spawn("rofi -show drun -fullscreen")
    ...
    -- {description = "run prompt", group = "super"}),
                 awful.key({modkey}, "x",
                           function() awful.util.spawn("arcolinux-logout") end,
    ...
    -- ctrl+alt +  ...
        ...
        group = "alt+ctrl"
                 ...
                 awful.key({modkey1, altkey}, "f",
                           function() awful.util.spawn(browser2) end,
                           {description = browser2, group = "alt+ctrl"}),
                 awful.key({modkey1, altkey}, "g",
                           function() awful.util.spawn(browser3) end,
        ...
        awful.spawn.with_shell("$HOME/.config/awesome/scripts/picom-toggle.sh")
                 ...
                 awful.key({modkey1, altkey}, "s",
                           function() awful.util.spawn(mediaplayer) end,
                           {description = mediaplayer, group = "alt+ctrl"}),
                 awful.key({modkey1, altkey}, "t",
                           function() awful.util.spawn(terminal) end,
    ...
    -- alt + ...
        ...
        awful.spawn.with_shell(
            "variety -p  && wal -i $(cat $HOME/.config/variety/wallpaper/wallpaper.jpg.txt)&")
                 ...
                 awful.key({altkey}, "t",
                           function() awful.util.spawn("variety -t") end,
                           {description = "Wallpaper trash", group = "altkey"}),
                 awful.key({altkey}, "n",
                           function() awful.util.spawn("variety -n") end,
                           {description = "Wallpaper next", group = "altkey"}),
                 awful.key({altkey}, "p",
                           function() awful.util.spawn("variety -p") end, {
        ...
        group = "altkey"
                 ...
                 awful.key({altkey}, "Right",
                           ...
                           {description = "Wallpaper next", group = "altkey"}),
                 awful.key({altkey}, "Up",
                           function() awful.util.spawn("variety --pause") end,
                           {description = "Wallpaper pause", group = "altkey"}),
                 awful.key({altkey}, "Down",
                           function() awful.util.spawn("variety --resume") end,
